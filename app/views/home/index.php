...
<body>
              ...
              <div class="summary-content fs-6">
                <?php foreach ($data['products'] as $products) : ?>
                  <div class="product-header d-flex justify-content-between mt-4">
                    <h3 class="display-7"><?= $products['nama'] ?></h3>
                    <div class="modal-close-btn">
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                      </button>
                    </div>
                  </div>
                  <span class="product-price fs-3">  </span>
                  ...
                  <div class="col-lg-9 col-md-8 col-sm-8">
                    ...
                    <div class="quantity-price d-flex justify-content-between align-items-center">
                      ...
                      <div class="price-code">
                        <span class="product-price fs-6">  </span>
                      </div>
                    </div>
                    <!-- quantity-price -->
                  </div>
      ...
      <div class="container-lg">
        <div class="row justify-content-evenly">
          ...
          <div class="col d-none d-md-block">
            <p class="text-center text-black m-0"><strong></strong>
            </p>
          </div>
          <div class="col">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              <li class="nav-item ">
                <a class="nav-link me-5 border-0" href="<?= BASEURL ?>/home" data-bs-toggle=""
                  aria-expanded="false">Home</a>

              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="">Makanan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="<?= BASEURL; ?>/product/">Produk</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link me-5 active dropdown-toggle border-0" href="#" data-bs-toggle="dropdown"
                  aria-expanded="false">Jasa</a>
                <ul class="dropdown-menu fw-bold">
                  <li>
                    <a href="<?= BASEURL; ?>/about" class="dropdown-item">About Us </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="index.html">Tempat Laundry </a>
                  </li>
                  <li>
  ...
  <section id="featured-products" class="product-store">
    <div class="container-md">
      <div class="display-header d-flex align-items-center justify-content-between">
        <h2 class="section-title text-uppercase"> rumah kos</h2>
        <div class="btn-right">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
          <div class="col mb-4">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL; ?>/images/localtobase/img1.jpeg" alt="product-item" class="product-image img-fluid " width="100%">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                ...
                <span class="card-price fw-bold">  </span>
              </div>
            </div>
          </div>
          <div class="col mb-4">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL; ?>/images/localtobase/images2.jpeg" alt="product-item" class="product-image img-fluid " width="100%">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL; ?>/images/localtobase/img3.jpeg" alt="product-item" class="product-image img-fluid " width="100%">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                    <a href="<?= BASEURL ?>/product/">
                      <button type="button" class="btn btn-light" data-bs-target="#modaltoggle" data-bs-toggle="modal">
          ...
          <div class="col mb-4">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL; ?>/images/localtobase/img4.jpeg" alt="product-item" class="product-image img-fluid " width="100%">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL; ?>/images/localtobase/images6.jpeg" alt="product-item" class="product-image img-fluid " width="100%">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
  ...
  <section id="latest-products" class="product-store py-2 my-2 py-md-5 my-md-5 pt-0">
    <div class="container-md">
      <div class="display-header d-flex align-items-center justify-content-between">
        <h2 class="section-title text-uppercase">warung makan </h2>
        <div class="btn-right">
          <a href="index.html" class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
        </div>
      </div>
      <div class="product-content padding-small">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src="<?= BASEURL?>/images/localtobase/warung1.jpeg" alt="product-item" class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
              <img src="<?= BASEURL?>/images/localtobase/warung2.jpeg" alt="product-item" class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
              <img src="<?= BASEURL?>/images/localtobase/warung3.jpeg" alt="product-item" class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
              <img src="<?= BASEURL?>/images/localtobase/warung4.jpeg" alt="product-item" class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
              <img src="<?= BASEURL?>/images/localtobase/warung5.jpeg" alt="product-item" class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
  ...
  <footer id="footer" class="py-5 border-top">
    <div class="container-lg">
      <div class="row">
        ...
        <div class="col-lg-2 pb-3">
          <div class="footer-menu">
            <h5 class="widget-title pb-2">Warung Makan</h5>
            <ul class="menu-list list-unstyled">
              <li class="pb-2">
                <a href="#">Track Your Order</a>
              </li>
